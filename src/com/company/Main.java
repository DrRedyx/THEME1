...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(book1.author.getName() + " " + book1.author.getSurName() + " " + book1.getPublishingYear());
        ...
        library.allOfBooks(book1);
        library.allOfBooks(book2);
        library.allOfBooks(book3);
        library.allOfBooks(book4);
        library.printBooks();
